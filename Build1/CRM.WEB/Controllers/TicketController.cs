...
namespace CRM.Controllers
{
    public class TicketController : Controller
    {
        //
        // GET: /CreatTicket/
        ITicketStore<Ticket> ticketStore;
        ...
        public ActionResult Create(TicketCreateModel m)
        {
            ...
            ticketStore=new TicketStore(new CRMContext("CRMContext"));
            TicketManager<Ticket, Guid> ticketManager = new TicketManager<Ticket, Guid>(ticketStore);
